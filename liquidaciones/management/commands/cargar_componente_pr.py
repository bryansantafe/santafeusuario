...
from liquidaciones.models import ComponentePR, Periodo 

class Command(BaseCommand):
    help = 'Carga los datos desde un archivo CSV para el Componente PR (Pérdidas)'
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            with open(ruta_csv, 'r', encoding='utf-8-sig') as archivo:
                ...
                for fila in lector_csv:
                    ...
                    if not operador_archivo or not valor_str or not nivel_str:
                        continue
                    ...
                    try:
                        ...
                        obj, creado = ComponentePR.objects.update_or_create(
                            periodo=periodo,
        ...
        self.stdout.write(self.style.SUCCESS("RESUMEN DE CARGA COMPONENTE PR:"))
